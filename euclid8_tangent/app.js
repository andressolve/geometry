/**
 * Main Application Logic for Lesson 8: Tangent Lines
 */

const App = {
    totalPages: 12,  // Pages 0-11
    currentPage: 0,
    ...
    initCanvases() {
        ...
        const canvasMap = {
            ...
            'canvas-page11-a': () => Diagrams.drawPage11A(document.getElementById('canvas-page11-a')),
            'canvas-page11-b': () => Diagrams.drawPage11B(document.getElementById('canvas-page11-b')),
            'canvas-page11-c': () => Diagrams.drawPage11C(document.getElementById('canvas-page11-c')),
            'canvas-page11-d': () => Diagrams.drawPage11D(document.getElementById('canvas-page11-d'))
        };
    ...
    init() {
        ...
        console.log('Lesson 8: Tangent Lines initialized');
    }
};
