/**
 * Main Application Logic for Lesson 6: Isosceles Triangles
 */
...
const App = {
    ...
    initCanvases() {
        ...
        // Interactive canvas for page 3 (only init once, not on resize)
        if (!this.page3Initialized) {
            const canvas3 = document.getElementById('canvas-page3');
            if (canvas3) {
                try {
                    Diagrams.initPage3Interactive(canvas3);
                    this.page3Initialized = true;
                } catch (e) {
