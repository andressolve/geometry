/**
 * Main Application Logic for Lesson 12: Lines in the Plane
 */
...
const App = {
    ...
    initCanvases() {
        const canvasMap = {
            ...
            'canvas-page3': () => Diagrams.drawPage3(document.getElementById('canvas-page3'), Discovery1.revealed),
    ...
    init() {
        ...
        console.log('Lesson 12: Lines in the Plane initialized');
    }
};
