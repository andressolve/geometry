/**
 * Main Application Logic for Lesson 14: Parallel Lines
 */
...
const App = {
    ...
    initCanvases() {
        const staticCanvases = {
            ...
            'canvas-contrast': () => Diagrams.drawContrast(document.getElementById('canvas-contrast')),
    ...
    init() {
        ...
        console.log('Lesson 14: Parallel Lines initialized');
    }
};
