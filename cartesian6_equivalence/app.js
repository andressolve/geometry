/**
 * Main Application Logic for Lesson 16: x + y = 1
 */
...
const App = {
    ...
    initCanvases() {
        const staticCanvases = {
            'canvas-downhill': () => Diagrams.drawDownhill(document.getElementById('canvas-downhill')),
            'canvas-equivalence': () => Diagrams.drawEquivalence(document.getElementById('canvas-equivalence')),
    ...
    init() {
        ...
        console.log('Lesson 16: x + y = 1 initialized');
    }
};
